                  ...
                  <div class="modal-body">
                    <form class="row g-3">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="validationDefault01" placeholder="Enter Your Username"
                          required>
                      </div>
                      <div class="col-md-12">
                      ...
                      <div class="modal-footer text-center">
                        <div class="d-grid gap-2 col-lg-8 col-sm-12 mx-auto">
                          <a class="btn btns text-light text-start " style="background-color: #3A5999;" href="#!"
                            role="button"><i class="bi bi-facebook fs-5 p-3"></i><b>Sign in with Facebook</b></a>
                          <a class="btn btns text-light text-start " style="background-color: #04ABEF;" href="#!"
                            role="button"><i class="bi bi-twitter fs-5 p-3"></i><b>Sign in with Twitter</b></a>
                          <a class="btn btns text-light text-start " style="background-color: #F34234;" href="#!"
                            role="button"><i class="bi bi-google fs-5 p-3 "></i><b>Sign in with Gmail</b></a>
                        </div>
                      </div>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="row g-3">
                      <div class="col-md-12">
                        ...
                        <input type="email" class="form-control" id="validationDefault03" placeholder="Enter Your Email"
                          required>
                      </div>
                      <div class="col-md-12">
                        <label class="text-dark">Username:</label>
                        <input type="text" class="form-control" id="validationDefault04" placeholder="Enter Your Username"
                          required>
                      </div>
                      <div class="col-md-12">
                        <label class="text-dark">Password:</label>
                      ...
                      <div class="col-md-12">
                        ...
                        <input type="password" class="form-control" id="validationDefault06"
                          placeholder="Enter Your Password" required>
                      </div>
                  ...
                  <div class="modal-footer">
                    <button class="btn " data-bs-target="#exampleModalToggle" data-bs-toggle="modal">You Already Have an
                      account?</button>
                  </div>
                </div>
              </div>
